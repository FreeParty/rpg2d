...
public class EnemiesData : MonoBehaviour
{
	...
	{ "-3", "ぬし",                  "30", "10", "10", "10", "4", "2", "27", "15", "30","0"},
        { "0", "ちんぴら",               "10", "0", "5", "4", "2", "0", "17", "4", "4","1"},
        { "1", "こわいひと",             "15", "0", "7","3", "2", "0", "18", "4", "10","2"},
        { "2", "おくすりまん",           "12", "3", "6","3", "1", "0", "17", "4", "4","1"},
        { "4", "しゅうきょうか",         "15", "10", "2", "3", "4", "1", "1", "5", "10","3"},
        { "5", "きぎょうせんし",         "8", "0", "8", "3", "1", "0", "12", "5", "10","1"},
        { "6", "げんきなこども",         "7", "0", "5", "3", "5", "0", "8", "2", "1","1"},
        { "7", "うるさいおばさん",       "15", "3", "4", "4", "2", "1", "21", "4", "3","1"},
        { "8", "よっぱらい",             "11", "0", "6", "6", "0", "0", "16", "6", "6","3"},
        { "9", "けもの",                 "12", "0", "8", "0", "6", "0", "1", "8", "0","3"},
    };
    public static string[,] eastSceneMonsters = new string[,] {
        { "0", "がくせい",              "16", "0", "10", "8", "4", "0", "2", "20", "8","1"},
        { "1", "トんだおじさん",        "18", "2", "12", "8", "2", "0", "17", "10", "4","2"},
        { "2", "うるさいおばさんV2",    "25", "2", "4", "8", "3", "1", "12", "12", "8","2"},
        { "3", "かみつきがめ",          "20", "0", "7", "15", "3", "0", "6", "5", "6","3"},
        { "4", "からす",                "10", "0", "15", "0", "6", "0", "1", "7", "0","1"},
    ...
    public static string[,] dendai2_1SceneMonsters = new string[,] {
        ...
        { "0", "でんだいせい",          "20", "2", "12", "8", "5", "0", "2", "11", "6","1"},
        { "1", "うぇい",                "18", "2", "14", "10", "5", "0", "2", "12", "10","1"},
        { "2", "いんきゃ",              "21", "6", "10", "10", "1", "0", "3", "11", "8","1"},
        { "3", "せいそういん",          "22", "6", "10", "9", "3", "0", "5", "14", "13","3"},
        { "4", "かーどげーまー",        "16", "20", "5", "8", "4", "1", "19", "13", "5","2"},
        { "5", "くさいがくせい",        "25", "3", "8", "15", "0", "0", "15", "20", "2","0"},
    };
    public static string[,] dendai2_2SceneMonsters = new string[,] {
        { "-3", "上級でんだいせい",     "50", "20", "15", "15", "5", "1", "24", "40", "40","0"},
    ...
    public static string[,] dendai1_1SceneMonsters = new string[,] {
        { "-3", "がっかたんとう",       "55", "30", "20","15", "8", "1", "20", "50", "60","0"},
