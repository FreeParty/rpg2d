...
public class ItemList : MonoBehaviour {
	...
	public static List<Items> item_table = new List<Items>(){
		...
		new Items (8,	"石ころ",		0, 		(int)scene.Battle, 		(int)Eff.Hp_damage, 	15,			"Images/item/isi",		"ただの石ころ\n投げる以外に用途はない"),
		new Items (9,	"こぼれ落ちた単位",		0, 		(int)scene.Battle, 		(int)Eff.Hp_damage, 	1,			"Images/item/chabuutou",		"こぼれ落ちたものには誰も興味を示さない\nしかしある敵は過剰に反応するのだという"),
		new Items (10,	"彼の拳",		0, 		(int)scene.Battle, 		(int)Eff.Hp_damage, 	40,			"Images/item/genkotu",		"抵抗するのだ\n彼のように"),
		new Items (11,	"エルのクーポン",		0, 		(int)scene.Battle, 		(int)Eff.Hp_damage, 	80,			"Images/item/kippu",		"いまは亡き「エル」の遺物\nしかし彼らは今でも声高に主張しているのだという"),
		new Items (12,	"火炎瓶",		0, 		(int)scene.Battle, 		(int)Eff.Hp_damage, 	100,			"Images/item/kaen",		"使用により、敵に傷を負わせる"),
		new Items (13,	"手榴弾",		0, 		(int)scene.Battle, 		(int)Eff.Hp_damage, 	130,			"Images/item/m67hahensyuryuudan",		"使用により、敵に傷を負わせる\nこれはかつてこの地で起きた悲劇を象徴するものだ"),
		new Items (14,	"ロードローラー",		0, 		(int)scene.Battle, 		(int)Eff.Hp_damage, 	1300,			"Images/item/auto",		"無駄無駄"),
		...
		new Items (16,	"レッドブル",		0, 		(int)scene.Battle, 		(int)Eff.At_up, 	(int)(PlayerContoroller.player_status["at"]*1.6),			"Images/item/edrink",		"力を一時的に上げる\n力が、みなぎってきた"),
		new Items (17,	"あやしい白い薬",		0, 		(int)scene.Battle, 		(int)Eff.At_up, 	(int)(PlayerContoroller.player_status["at"]*2.3),			"Images/item/med_tablet",		"力を一時的に大きく上げる\n使うともう、後戻りできない"),
		...
		new Items (19,	"電磁気学基礎の単位",		0, 		(int)scene.Battle, 		(int)Eff.Df_up, 	(int)(PlayerContoroller.player_status["df"]*1.6),			"Images/item/datdocum",		"守りを一時的に上げる、希少なモノ\nこれを求める者は後を絶たない"),
